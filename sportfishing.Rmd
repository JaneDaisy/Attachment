...
setwd("~/Jane_Repository/Attachment")
...
sportfishing <- readr::read_csv('~/Jane_Repository/Attachment/sportfishing.csv')%>%
  janitor::clean_names()
...
#colnames(sportfishing_clean)

readr::write_csv(sportfishing_clean, "~/Jane_Repository/Attachment/sportfishing_clean.csv", na = "")
...
#write the csv
readr::write_csv(sportfishing_clean,"~/Jane_Repository/Attachment/sportfishing.csv",na='')

#read data
sportfishing_clean <- readr::read_csv('~/Jane_Repository/Attachment/sportfishing.csv')
